...
struct RequestHealthAccessView: View {
    ...
    var body: some View {
        VStack {
            ...
            Text("We have a variety of access and permissions needed. Please click the buttons below to grant accesses.")
                ...
                .padding(10)
            Rectangle()
                .frame(width: 340, height: 5, alignment: .center)
                .foregroundColor(.white)
        ...
        .background(
            LinearGradient(gradient: Gradient(colors: [.cyan, .blue, .indigo]), startPoint: .top, endPoint: .bottom)
                .edgesIgnoringSafeArea(.all))
    }
}


struct RequestHealthAccessView_Previews: PreviewProvider {
